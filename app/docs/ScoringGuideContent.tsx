  ...
  return (
    <div>
      ...
      <div style={{ background: 'rgba(0,165,163,0.06)', border: '1px solid rgba(0,165,163,0.2)', borderRadius: '16px', padding: '28px 32px', marginBottom: '28px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px' }}>
          <div>
            ...
            <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.75)', lineHeight: 1.7, marginBottom: '14px' }}>
      ...
      <div style={{ marginBottom: '28px' }}>
        <div style={{ fontSize: '13px', fontWeight: 700, letterSpacing: '2px', textTransform: 'uppercase', color: 'rgba(255,255,255,0.5)', marginBottom: '16px' }}>How the Score Is Built — 3 Dimensions</div>
          ...
          {[
            ...
            <div key={dim.num} style={{ background: 'rgba(255,255,255,0.04)', border: `1px solid ${dim.color}25`, borderRadius: '16px', padding: '22px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px' }}>
                ...
                <div>
                  <div style={{ fontSize: '13px', fontWeight: 800, color: 'white' }}>{dim.label}</div>
                  <div style={{ fontSize: '13px', fontWeight: 700, color: dim.color }}>{dim.pts}</div>
                </div>
              </div>
              <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.7)', lineHeight: 1.6, marginBottom: '12px' }}>{dim.what}</div>
              <div style={{ borderTop: `1px solid ${dim.color}18`, paddingTop: '12px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <div>
                  ...
                  <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.82)', lineHeight: 1.5 }}>{dim.how}</div>
                </div>
                <div>
                  ...
                  <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.82)', lineHeight: 1.5 }}>{dim.why}</div>
                </div>
                <div style={{ background: `${dim.color}08`, border: `1px solid ${dim.color}15`, borderRadius: '8px', padding: '8px 10px' }}>
                  ...
                  <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.80)', lineHeight: 1.5, fontStyle: 'italic' }}>{dim.example}</div>
                </div>
              </div>
            </div>
          ))}
        ...
        <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '14px', padding: '18px 24px', display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
          <div style={{ fontSize: '13px', fontWeight: 700, color: 'rgba(255,255,255,0.5)', letterSpacing: '1px', textTransform: 'uppercase', flexShrink: 0 }}>Formula:</div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
            <span style={{ fontSize: '13px', fontWeight: 800, color: '#00897B', background: 'rgba(0,165,163,0.12)', padding: '4px 12px', borderRadius: '7px' }}>AI Fluency (max 40)</span>
            <span style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', fontWeight: 300 }}>+</span>
            <span style={{ fontSize: '13px', fontWeight: 800, color: '#7A6600', background: 'rgba(244,237,60,0.1)', padding: '4px 12px', borderRadius: '7px' }}>Digital Maturity (max 35)</span>
            <span style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', fontWeight: 300 }}>+</span>
            <span style={{ fontSize: '13px', fontWeight: 800, color: '#8B1A1A', background: 'rgba(139,26,26,0.1)', padding: '4px 12px', borderRadius: '7px' }}>Engagement (max 25)</span>
            <span style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', fontWeight: 300 }}>=</span>
            <span style={{ fontSize: '13px', fontWeight: 900, color: 'white', background: 'rgba(255,255,255,0.09)', padding: '4px 14px', borderRadius: '7px' }}>TAIRS (0–100)</span>
          </div>
        </div>
      </div>
      ...
      {/* 5-Tier Ladder */}
      <div style={{ marginBottom: '28px' }}>
        <div style={{ fontSize: '13px', fontWeight: 700, letterSpacing: '2px', textTransform: 'uppercase', color: 'rgba(255,255,255,0.5)', marginBottom: '16px' }}>The 5-Tier Ladder</div>
          ...
          {[
            ...
            <div key={tier.tier} style={{ display: 'grid', gridTemplateColumns: '140px 1fr 1fr', background: i % 2 === 0 ? 'rgba(255,255,255,0.03)' : 'transparent' }}>
              <div style={{ padding: '20px', borderRight: '1px solid rgba(255,255,255,0.06)', display: 'flex', flexDirection: 'column', gap: '4px' }}>
                <span style={{ fontSize: '13px', fontWeight: 900, color: tier.color, background: `${tier.color}18`, padding: '2px 8px', borderRadius: '5px', width: 'fit-content' }}>{tier.tier}</span>
              ...
              <div style={{ padding: '20px', borderRight: '1px solid rgba(255,255,255,0.06)' }}>
                ...
                <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.75)', lineHeight: 1.55 }}>{tier.what}</div>
              </div>
              <div style={{ padding: '20px' }}>
                ...
                <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.75)', lineHeight: 1.55 }}>{tier.action}</div>
              </div>
            </div>
          ))}
        </div>
