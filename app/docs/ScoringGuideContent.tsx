  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: '28px' }}>
        <div style={{ fontSize: '12px', fontWeight: 700, letterSpacing: '2px', textTransform: 'uppercase', color: 'rgba(255,255,255,0.5)', marginBottom: '16px' }}>How the Score Is Built — 3 Dimensions</div>
        ...
        <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '14px', padding: '18px 24px', display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
          <div style={{ fontSize: '11px', fontWeight: 700, color: 'rgba(255,255,255,0.5)', letterSpacing: '1px', textTransform: 'uppercase', flexShrink: 0 }}>Formula:</div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
            ...
            <span style={{ fontSize: '16px', color: 'rgba(255,255,255,0.4)', fontWeight: 300 }}>+</span>
      ...
      {/* 5-Tier Ladder */}
      <div style={{ marginBottom: '28px' }}>
        <div style={{ fontSize: '12px', fontWeight: 700, letterSpacing: '2px', textTransform: 'uppercase', color: 'rgba(255,255,255,0.5)', marginBottom: '16px' }}>The 5-Tier Ladder</div>
          ...
          {[
            ...
            <div key={tier.tier} style={{ display: 'grid', gridTemplateColumns: '140px 1fr 1fr', background: i % 2 === 0 ? 'rgba(255,255,255,0.03)' : 'transparent' }}>
              <div style={{ padding: '18px 20px', borderRight: '1px solid rgba(255,255,255,0.06)', display: 'flex', flexDirection: 'column', gap: '4px' }}>
                <span style={{ fontSize: '10px', fontWeight: 900, color: tier.color, background: `${tier.color}18`, padding: '2px 8px', borderRadius: '5px', width: 'fit-content' }}>{tier.tier}</span>
              ...
              <div style={{ padding: '18px 20px' }}>
                ...
                <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.75)', lineHeight: 1.55 }}>{tier.action}</div>
              </div>
            </div>
          ))}
        </div>
