  ...
  return (
    <div>
      <div style={{ marginBottom: '28px' }}>
        <div style={{ fontSize: '11px', fontWeight: 800, letterSpacing: '2px', textTransform: 'uppercase', color: 'var(--purple)', marginBottom: '8px' }}>Operations Reference</div>
        <h1 style={{ fontSize: '28px', fontWeight: 900, color: 'var(--ink)', margin: '0 0 10px', letterSpacing: '-0.5px' }}>AI Readiness Playbook</h1>
        <p style={{ fontSize: '15px', color: 'var(--ink3)', lineHeight: 1.65, margin: 0 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '40px' }}>
        {PLAYBOOK.map(row => (
          <div key={row.tier} style={{ background: 'var(--card)', border: `1px solid ${row.color}25`, borderLeft: `4px solid ${row.color}`, borderRadius: '12px', padding: '20px 24px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '16px' }}>
              <div>
                <div style={{ fontSize: '10px', fontWeight: 800, letterSpacing: '1.5px', textTransform: 'uppercase', color: 'var(--ink4)', marginBottom: '4px' }}>What it means</div>
                <div style={{ fontSize: '14px', color: 'var(--ink3)', lineHeight: 1.55 }}>{row.means}</div>
              </div>
              <div>
                <div style={{ fontSize: '10px', fontWeight: 800, letterSpacing: '1.5px', textTransform: 'uppercase', color: 'var(--ink4)', marginBottom: '4px' }}>Recommended Action</div>
                <div style={{ fontSize: '14px', color: 'var(--ink)', fontWeight: 600, lineHeight: 1.55 }}>{row.action}</div>
              </div>
              <div>
                <div style={{ fontSize: '10px', fontWeight: 800, letterSpacing: '1.5px', textTransform: 'uppercase', color: 'var(--ink4)', marginBottom: '4px' }}>Immediate Next Step</div>
                <div style={{ fontSize: '14px', color: 'var(--ink3)', lineHeight: 1.55 }}>{row.next}</div>
              </div>
              <div style={{ display: 'flex', gap: '24px' }}>
                <div>
                  <div style={{ fontSize: '10px', fontWeight: 800, letterSpacing: '1.5px', textTransform: 'uppercase', color: 'var(--ink4)', marginBottom: '4px' }}>Owner</div>
                  <div style={{ fontSize: '14px', color: row.color, fontWeight: 700 }}>{row.owner}</div>
                </div>
                <div>
                  <div style={{ fontSize: '10px', fontWeight: 800, letterSpacing: '1.5px', textTransform: 'uppercase', color: 'var(--ink4)', marginBottom: '4px' }}>By</div>
      ...
      <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: '14px', overflow: 'hidden' }}>
        <div style={{ padding: '16px 20px', borderBottom: '1px solid var(--border)' }}>
          <div style={{ fontSize: '12px', fontWeight: 800, letterSpacing: '1.5px', textTransform: 'uppercase', color: 'var(--ink3)' }}>Quick Reference Table</div>
        </div>
            ...
            <thead>
              <tr>
                {['Tier', 'Range', 'Action', 'Owner', 'Timeline'].map(h => (
                  <th key={h} style={{ padding: '10px 16px', textAlign: 'left', fontSize: '10px', fontWeight: 700, letterSpacing: '1px', textTransform: 'uppercase', color: 'var(--ink4)', borderBottom: '1px solid var(--border)', whiteSpace: 'nowrap', background: 'var(--border-light)' }}>{h}</th>
                ))}
              </tr>
            </thead>
            <tbody>
              {PLAYBOOK.map((row, i) => (
                <tr key={row.tier} style={{ borderBottom: i < PLAYBOOK.length - 1 ? '1px solid var(--border-light)' : 'none' }}>
                  ...
                  <td style={{ padding: '12px 16px', fontSize: '13px', color: 'var(--ink)', fontWeight: 600, lineHeight: 1.5 }}>{row.action}</td>
