...
const COURSES = [
  ...
  /* ─── FOUNDATION 2 ─────────────────────────────────────────── */
  {
    ...
    dept_tags:  [],
    is_mandatory: true,
    overview:  `Half the people who say "AI doesn't work for me" are using it for the wrong things. The other half have inflated expectations and get disappointed. This course cuts through both problems.\n\nYou'll build a clear mental model of what AI tools actually are, what tasks they genuinely accelerate, and where human judgment still beats the machine. This mental model is the foundation for everything else in the TAI training path.`,
