...
export async function POST(req: Request) {
  try {
    ...
    const { id, label, event_name, description, repo_url, folder_name, tech, pages, style_tags, color_bg, color_accent, color_highlight, preview_url, sort_order } = body
