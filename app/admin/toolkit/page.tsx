    ...
    <div style={{ minHeight: '100vh', background: '#E8EEF4', fontFamily: 'var(--font-manrope), Manrope, sans-serif' }}>
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '56px 40px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(320px, 1fr))', gap: '24px' }}>
          ...
          <div style={{ background: '#FFFFFF', border: '1px solid #DDE8EE', borderRadius: '20px', padding: '32px', position: 'relative', overflow: 'hidden', opacity: 0.55 }}>
            ...
            <div style={{ fontSize: '15px', color: '#5B7080', lineHeight: 1.6 }}>
              AI-powered voice and WhatsApp outreach agent. Automates delegate acquisition at scale. Launching soon.
            </div>
          </div>
        </div>
      </div>
