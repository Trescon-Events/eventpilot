...
export default function KnowledgeAssistantSettingsPage() {
  return (
    <div style={{ minHeight: '100vh', background: 'var(--surface)', fontFamily: 'var(--font-manrope), sans-serif' }}>
      <PageHeader eyebrow="Knowledge Assistant" title="Settings" />
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '24px' }}>
        ...
        <AccessTab moduleKey="knowledge-assistant" moduleLabel="Knowledge Assistant" />
      </div>
    </div>
  )
}
