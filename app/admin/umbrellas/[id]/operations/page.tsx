...
import OperationsHubView from '@/app/admin/operations-shared/OperationsHubView'
...
export default function Page({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params)
  return <OpsScopeProvider kind="umbrella" id={id}><OperationsHubView /></OpsScopeProvider>
}
