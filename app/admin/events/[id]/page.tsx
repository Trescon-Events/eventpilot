  ...
  return (
    <div style={{ fontFamily: 'var(--font-manrope), Manrope, sans-serif', background: '#E8EEF4', minHeight: '100vh', color: '#0F1923' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 32px' }}>
        ...
        {/* ── Commercial P&L — Link to Commercial Tracker ─────────────── */}
        <div style={{ marginBottom: '40px', background: '#FFFFFF', border: '1px solid #D8EAEB', borderRadius: '20px', padding: '28px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
              ...
              <h2 style={{ fontSize: '18px', fontWeight: 900, color: '#0F1923', margin: 0 }}>Commercial P&amp;L</h2>
            </div>
            <p style={{ fontSize: '14px', color: '#5B7080', margin: 0 }}>Revenue targets, deals, expenses, staff costs, overheads, profit &amp; loss, scenarios, and approvals.</p>
          </div>
          <Link href={`/admin/commercial/${eventId}`} style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '12px 24px', borderRadius: '10px', background: '#00A5A3', color: '#FFFFFF', fontSize: '14px', fontWeight: 700, textDecoration: 'none', whiteSpace: 'nowrap', boxShadow: '0 2px 8px rgba(0,165,163,0.3)' }}>
