...
import MemberFilterRow from './ai-learning/MemberFilterRow'
...
function AdminPageInner() {
  ...
  type AdminTab = 'overview' | 'people' | 'ai-learning' | 'events' | 'commercial' | 'review' | 'toolkit' | 'security' | 'finance' | 'hr' | 'branding'
  type AiLearningSub = 'readiness' | 'analytics' | 'course-generator'
  ...
  const [aiLearningSub, setAiLearningSub] = useState<AiLearningSub>(() => {
    ...
    return s === 'course-generator' || s === 'analytics' ? s : 'readiness'
  })
  ...
  if (searchParamsSub !== lastSyncedSub) {
    ...
    if (searchParamsSub === 'course-generator' || searchParamsSub === 'analytics' || searchParamsSub === 'readiness') setAiLearningSub(searchParamsSub)
  }
  ...
  const TOUR_STEPS = [
    { id: 'tour-tabs',             title: 'Your main sections',         desc: 'Navigate between Overview, All Staff, AI Learning, Events, Knowledge Base, and more using these tabs.' },
    { id: 'tour-stats',            title: 'Org readiness at a glance',  desc: 'Total staff in the system and how many have completed their profile — updating in real time.' },
    ...
    { id: 'tour-ai-learning-tab',  title: 'AI Learning',                desc: 'AI-generated readiness analysis (department breakdowns, tier distributions, what to do about gaps), course analytics, and the AI course generator — all in one place. Describe a skill gap and Gemini designs a full course in under a minute.' },
  ...
  return (
    <div style={{ fontFamily: 'var(--font-manrope), Manrope, sans-serif', background: 'var(--surface)', minHeight: '100vh', color: 'var(--ink)' }}>
      ...
      <div style={{ padding: '40px' }}>
          ...
          return (
            <div id="tour-tabs" style={{ display: 'flex', gap: '6px', marginBottom: '28px', flexWrap: 'wrap' }}>
              {([
                ...
                return (
                  <button key={t}
                    id={t === 'ai-learning' ? 'tour-ai-learning-tab' : undefined}
          ...
          <div id="tour-started" style={{ marginBottom: '28px', background: 'rgba(0,165,163,0.06)', border: '1px solid rgba(0,165,163,0.2)', borderRadius: '16px', padding: '24px 28px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              {[
                ...
                { key: 'brief', label: 'Explore AI Learning to see org-wide readiness insights', action: () => { setTab('ai-learning'); setAiLearningSub('readiness'); syncAdminUrl('ai-learning', 'readiness'); markProgress('brief') }, tab: 'AI Learning' },
        ...
        <div id="tour-stats" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px', marginBottom: '28px' }}>
