  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F6FFFE', color: '#1E2124', padding: '40px 48px', fontFamily: 'inherit' }}>
      <style>{`
        ...
        .filter-btn { padding: 6px 14px; border-radius: 7px; font-size: 13px; font-weight: 700; cursor: pointer; border: 1px solid #C8DFE0; background: #FFFFFF; color: #464D53; font-family: inherit; transition: all 0.15s; }
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '32px' }}>
        <div>
          <Link href="/admin" style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', fontSize: '13px', color: '#1E2124', textDecoration: 'none', marginBottom: '12px' }}>
          ...
          <p style={{ fontSize: '15px', color: '#1E2124', marginTop: '6px' }}>
        ...
        <div style={{ background: 'rgba(0,165,163,0.04)', border: '1px solid rgba(0,165,163,0.2)', borderRadius: '16px', padding: '28px', marginBottom: '32px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px', marginBottom: '14px' }}>
            ...
            <div style={{ gridColumn: '1/-1' }}>
              <label style={{ fontSize: '11px', fontWeight: 700, color: '#1E2124', letterSpacing: '0.8px', textTransform: 'uppercase', display: 'block', marginBottom: '5px' }}>Campaign Name</label>
            ...
            {/* Event */}
            <div>
              <label style={{ fontSize: '11px', fontWeight: 700, color: '#1E2124', letterSpacing: '0.8px', textTransform: 'uppercase', display: 'block', marginBottom: '5px' }}>Event (optional)</label>
            ...
            {/* Phase */}
            <div>
              <label style={{ fontSize: '11px', fontWeight: 700, color: '#1E2124', letterSpacing: '0.8px', textTransform: 'uppercase', display: 'block', marginBottom: '5px' }}>Phase</label>
            ...
            {/* Start date */}
            <div>
              <label style={{ fontSize: '11px', fontWeight: 700, color: '#1E2124', letterSpacing: '0.8px', textTransform: 'uppercase', display: 'block', marginBottom: '5px' }}>Start Date</label>
            ...
            {/* Duration */}
            <div>
              <label style={{ fontSize: '11px', fontWeight: 700, color: '#1E2124', letterSpacing: '0.8px', textTransform: 'uppercase', display: 'block', marginBottom: '5px' }}>Duration (weeks)</label>
            ...
            {/* Objective */}
            <div style={{ gridColumn: '1/-1' }}>
              <label style={{ fontSize: '11px', fontWeight: 700, color: '#1E2124', letterSpacing: '0.8px', textTransform: 'uppercase', display: 'block', marginBottom: '5px' }}>Objective</label>
          ...
          <div style={{ marginBottom: '14px' }}>
            <label style={{ fontSize: '10px', fontWeight: 700, color: '#1E2124', letterSpacing: '0.8px', textTransform: 'uppercase', display: 'block', marginBottom: '8px' }}>Platforms</label>
          ...
          <div style={{ marginBottom: '20px' }}>
            <label style={{ fontSize: '11px', fontWeight: 700, color: '#1E2124', letterSpacing: '0.8px', textTransform: 'uppercase', display: 'block', marginBottom: '5px' }}>Brand Notes <span style={{ color: '#1E2124', fontWeight: 400, textTransform: 'none' }}>(optional — AI reads your event brief automatically)</span></label>
      ...
      {(events.length > 0 || campaigns.length > 0) && (
        <div style={{ display: 'flex', gap: '8px', marginBottom: '24px', flexWrap: 'wrap', alignItems: 'center' }}>
          <span style={{ fontSize: '11px', fontWeight: 700, color: '#1E2124', letterSpacing: '1px', textTransform: 'uppercase' }}>Event</span>
          ...
          <span style={{ fontSize: '11px', fontWeight: 700, color: '#1E2124', letterSpacing: '1px', textTransform: 'uppercase' }}>Phase</span>
      ...
      {/* Campaign grid */}
      {loading ? (
        <div style={{ textAlign: 'center', padding: '80px', color: '#1E2124', fontSize: '15px' }}>Loading…</div>
      ) : filtered.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '80px 40px', background: '#FFFFFF', border: '1px dashed #C8DFE0', borderRadius: '20px' }}>
          ...
          <div style={{ fontSize: '15px', color: '#1E2124', marginBottom: '20px' }}>Create your first campaign to start generating content for your events.</div>
            ...
            return (
              <div key={c.id} className="cc-card">
                ...
                <div style={{ padding: '20px' }}>
                  ...
                  {/* Event */}
                  {c.events && (
                    <div style={{ fontSize: '13px', color: '#1E2124', marginBottom: '12px' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
                    ...
                    <span style={{ fontSize: '13px', color: '#1E2124' }}>{cnt} posts</span>
                  </div>
...
export default function ContentHubPage() {
  return (
    <Suspense fallback={<div style={{ fontFamily: 'var(--font-manrope), Manrope, sans-serif', background: '#F6FFFE', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><div style={{ color: '#1E2124', fontSize: '16px' }}>Loading…</div></div>}>
      <ContentHubInner />
    </Suspense>
  )
}
