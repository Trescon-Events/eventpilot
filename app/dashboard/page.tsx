      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '40px 24px 80px' }}>
        ...
        {(() => {
          ...
          if (isMgmt) {
            ...
            wsColor  = '#DC2626'
            wsTiles  = [
              ...(hasTool('content') ? [{ label: 'Content Engine', href: '/content',         color: '#F59E0B' }] : []),
        ...
        {(() => {
          ...
          const tiles = [
            ...
            { label: 'Content Engine',        sub: 'AI content, calendar & publishing', color: '#F59E0B', href: '/content',                                              icon: <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" viewBox="0 0 24 24"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>, show: hasTool('content') || staff.department === 'Marketing' || staff.department === 'Content & Design' },
            { label: 'Messages',              sub: 'Team conversations',              color: '#1565C0', href: `/messages?id=${staffId}`,                                  icon: <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" viewBox="0 0 24 24"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>, show: true },
            { label: 'TresAgent',             sub: 'AI voice & WhatsApp outreach',    color: '#EC4899', href: 'https://trescon-reach.vercel.app',                       icon: <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" viewBox="0 0 24 24"><path d="M12 2a10 10 0 1 0 10 10"/><path d="M12 6v6l4 2"/><circle cx="19" cy="5" r="3"/></svg>, show: hasTool('tresagent') },
