...
Your job is to analyse all submissions and produce a structured intelligence report for Trescon's leadership team. The goal: identify where AI can save the most time, what to build first in Trescademy (Trescon's internal AI learning and operations platform), and what training is needed.
...

{
  ...
  "build_priority": [
    {
      "rank": 1,
      "title": "<specific thing to build in Trescademy>",
