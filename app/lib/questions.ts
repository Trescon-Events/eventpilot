...
export const CORE_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    subtext: 'Rate yourself on your top 4 tools. Be honest — this shapes the courses Event Pilot recommends specifically for you.',
    type: 'proficiency',
  },
  {
    id: 'tools_unlisted',
    question: 'Using a tool we didn\'t mention above?',
    subtext: 'Tell us the name and what you use it for. This helps Event Pilot build a complete picture of how you work.',
    type: 'text',
  ...
  },
  {
    ...
    subtext: 'Your answer here determines your starting track on Event Pilot. Levels 4–5 mean you will be expected to lead an AI pilot in your department — not just attend training.',
    type: 'scale',
    options: [
