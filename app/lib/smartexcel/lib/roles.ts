// Role + permission model, ported as-is (PRD §4). Super Admin is permanent,
// non-revokable, and bypasses permission checks entirely. Admin/Standard
// permissions are data-driven (role_permissions table) and tunable from the
// admin panel.
